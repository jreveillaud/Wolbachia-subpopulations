...
gene_clusters_df <- read.table(file = '../pangenomics/Wolbachia-O11-M11-PAN-SUMMARY/Wolbachia_gene_clusters_summary.txt',
                               header = TRUE,
                               sep = "\t",
                               quote = "")
...
# Save
write.table(output_df_short, "metapangenomics/coverages-for-gene-clusters-O11-M11.txt", quote=FALSE, sep="\t", na="", row.names=FALSE)
```
