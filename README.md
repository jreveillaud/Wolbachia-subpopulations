...
* [8-merge-gene-cluster-SNV.R](files/script/snv_metapan/8-merge-gene-cluster-SNV.R): Identify shared SNVs, Single copy Core Genes from *Wolbachia* (*w*SCG) from the Gene Cluster tables (pangenomics), link the *w*SCG and SNVs informations to export it in SNV interactive databases.
...
* [9b-SNV-figure-for-selected-splits-eggs.Rmd](files/script/snv_metapan/9b-SNV-figure-for-selected-splits-eggs.Rmd): Same as 9a but with egg metagenomes
